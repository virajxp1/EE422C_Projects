...
If everything goes well, for your submission in the brief_results.csv you should have a positive number
of total test cases and 0 error, failure, and ignored tests.
If all the numbers are 0, something went wrong (compilation/structure error).
...
Project4_compileError.zip               : this submission causes compile error as it is not compatible with the test cases.
Project4_submissionStructureError.zip   : this submission does not have the appropriate format
Project4_someTestsFailure.zip           : this submission has appropriate format and compiles. It passes some (not all) of the tests.

After performing grading the brief results for the sample submissions should be exactly like this:

"submission_name", "total", "fail", "error", "skipped"
"Project4_submissionStructureError", 0, 0, 0, 0
"Project4_compileError" , 0 , 0 , 0 , 0
"Project4_someTestsFailure" , 7 , 3 , 3 , 0
